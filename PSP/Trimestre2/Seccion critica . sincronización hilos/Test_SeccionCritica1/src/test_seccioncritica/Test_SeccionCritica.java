...
public class Test_SeccionCritica {
    ...
    public static void main(String[] args) {
        ...
        /* LOS HILOS ACCEDEN AL MISMO OBJETO, NO A DISTINTOS OBJETOS INSTANCIAS DE LA MISMA CLASE*/ 
         ...
         */
        /**FIJARSE ESTO SERÍA IMPOSIBLE EN UNA APLIC MULTIPORCESO, LOS PROCESOS (NO COMPARTEN BLOQUE DE MEMORIA***
